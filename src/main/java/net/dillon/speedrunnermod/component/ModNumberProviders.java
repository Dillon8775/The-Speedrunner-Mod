...
public class ModNumberProviders {
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_LOG = createNumberProvider("speedrunner_log");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_LOG = createNumberProvider("dead_speedrunner_log");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_WOOD = createNumberProvider("speedrunner_wood");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_WOOD = createNumberProvider("dead_speedrunner_wood");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_SAPLING = createNumberProvider("speedrunner_sapling");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_SAPLING = createNumberProvider("dead_speedrunner_sapling");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_BUSH = createNumberProvider("dead_speedrunner_bush");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_STICK = createNumberProvider("speedrunner_stick");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_PLANKS = createNumberProvider("speedrunner_planks");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_PLANKS = createNumberProvider("dead_speedrunner_planks");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_BOAT = createNumberProvider("speedrunner_boat");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_CHEST_BOAT = createNumberProvider("speedrunner_chest_boat");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_BOAT = createNumberProvider("dead_speedrunner_boat");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_CHEST_BOAT = createNumberProvider("dead_speedrunner_chest_boat");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_SLAB = createNumberProvider("speedrunner_slab");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_SLAB = createNumberProvider("dead_speedrunner_slab");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_STAIRS = createNumberProvider("speedrunner_stairs");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_STAIRS = createNumberProvider("dead_speedrunner_stairs");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_TRAPDOOR = createNumberProvider("speedrunner_trapdoor");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_TRAPDOOR = createNumberProvider("dead_speedrunner_trapdoor");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_DOOR = createNumberProvider("speedrunner_door");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_DOOR = createNumberProvider("dead_speedrunner_door");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_PRESSURE_PLATE = createNumberProvider("speedrunner_pressure_plate");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_PRESSURE_PLATE = createNumberProvider("dead_speedrunner_pressure_plate");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_FENCE = createNumberProvider("speedrunner_fence");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_FENCE = createNumberProvider("dead_speedrunner_fence");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_FENCE_GATE = createNumberProvider("speedrunner_fence_gate");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_FENCE_GATE = createNumberProvider("dead_speedrunner_fence_gate");

    public static final ResourceKey<ContextIntProvider> COOKING_TIME_SPEEDRUNNER_BUTTON = createNumberProvider("speedrunner_button");
    public static final ResourceKey<ContextIntProvider> COOKING_TIME_DEAD_SPEEDRUNNER_BUTTON = createNumberProvider("dead_speedrunner_button");
     ...
     */
    private static ResourceKey<ContextIntProvider> createNumberProvider(final String location) {

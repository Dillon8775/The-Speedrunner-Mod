...
public class GhastEntityMixin extends FlyingEntity {
    ...
    public int getExperienceToDrop(ServerWorld world) {
        if (this.attackingPlayer != null) {
            this.experiencePoints = 5 + EnchantmentHelper.getEquipmentLevel(ItemUtil.entityEnchantment((GhastEntity)(Object)this, Enchantments.LOOTING), this.attackingPlayer) * 36;
        }

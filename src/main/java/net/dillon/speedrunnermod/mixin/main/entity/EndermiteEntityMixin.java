...
public class EndermiteEntityMixin extends HostileEntity {
    ...
    public int getExperienceToDrop(ServerWorld world) {
        if (this.attackingPlayer != null) {
            this.experiencePoints = 5 + EnchantmentHelper.getEquipmentLevel(ModUtil.entityEnchantment((EndermiteEntity)(Object)this, Enchantments.LOOTING), this.attackingPlayer) * 16;
        }

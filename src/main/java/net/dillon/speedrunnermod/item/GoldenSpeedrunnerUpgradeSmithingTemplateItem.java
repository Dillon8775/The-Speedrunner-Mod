 ...
 */
public class GoldenSpeedrunnerUpgradeSmithingTemplateItem extends SmithingTemplateItem {
    ...
    public GoldenSpeedrunnerUpgradeSmithingTemplateItem(Settings settings) {
        super(GOLDEN_SPEEDRUNNER_UPGRADE_APPLIES_TO_TEXT,
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, TooltipDisplayComponent displayComponent, Consumer<Text> textConsumer, TooltipType type) {
        textConsumer.accept(Text.translatable("item.speedrunnermod.golden_speedrunner_upgrade_smithing_template.tooltip"));

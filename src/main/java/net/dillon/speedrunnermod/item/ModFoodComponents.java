...
public class ModFoodComponents {
    ...
    static {
        ...
        GOLDEN_PIGLIN_PORK = options().general.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(8).saturationModifier(0.9F).build() : new FoodProperties.Builder().nutrition(8).saturationModifier(0.8F).build();
        GOLDEN_BEEF = options().general.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(8).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(8).saturationModifier(0.9F).build();
        GOLDEN_PORKCHOP = options().general.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(8).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(8).saturationModifier(0.9F).build();
        GOLDEN_MUTTON = options().general.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(6).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(8).saturationModifier(0.9F).build();
        GOLDEN_CHICKEN = options().general.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(6).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(8).saturationModifier(0.7F).build();
        GOLDEN_RABBIT = options().general.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(5).saturationModifier(1.2F).build() : new FoodProperties.Builder().nutrition(5).saturationModifier(0.7F).build();
        GOLDEN_COD = options().general.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(5).saturationModifier(1.2F).build() : new FoodProperties.Builder().nutrition(5).saturationModifier(0.7F).build();
        GOLDEN_SALMON = options().general.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(6).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(6).saturationModifier(0.9F).build();
        GOLDEN_BREAD = options().general.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(5).saturationModifier(1.2F).build() : new FoodProperties.Builder().nutrition(5).saturationModifier(0.7F).build();
        GOLDEN_POTATO = options().general.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(6).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(5).saturationModifier(0.7F).build();
        GOLDEN_BEETROOT = options().general.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(2).saturationModifier(1.5F).build() : new FoodProperties.Builder().nutrition(2).saturationModifier(0.7F).build();

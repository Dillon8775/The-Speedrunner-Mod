...
public class ModFoodComponents {
    ...
    protected static final FoodProperties GOLDEN_PIGLIN_PORK;
    protected static final FoodProperties GOLDEN_BEEF;
    protected static final FoodProperties GOLDEN_PORKCHOP;
    protected static final FoodProperties GOLDEN_MUTTON;
    protected static final FoodProperties GOLDEN_CHICKEN;
    protected static final FoodProperties GOLDEN_RABBIT;
    protected static final FoodProperties GOLDEN_COD;
    protected static final FoodProperties GOLDEN_SALMON;
    protected static final FoodProperties GOLDEN_BREAD;
    protected static final FoodProperties GOLDEN_POTATO;
    protected static final FoodProperties GOLDEN_BEETROOT;
    ...
    static {
        ...
        PIGLIN_PORK = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(4).saturationModifier(0.3F).build() : new FoodProperties.Builder().nutrition(3).saturationModifier(0.2F).build();
        COOKED_PIGLIN_PORK = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(8).saturationModifier(0.8F).build() : new FoodProperties.Builder().nutrition(8).saturationModifier(0.7F).build();
        GOLDEN_PIGLIN_PORK = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(8).saturationModifier(0.9F).build() : new FoodProperties.Builder().nutrition(8).saturationModifier(0.8F).build();
        GOLDEN_BEEF = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(8).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(8).saturationModifier(0.9F).build();
        GOLDEN_PORKCHOP = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(8).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(8).saturationModifier(0.9F).build();
        GOLDEN_MUTTON = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(6).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(8).saturationModifier(0.9F).build();
        GOLDEN_CHICKEN = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(6).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(8).saturationModifier(0.7F).build();
        GOLDEN_RABBIT = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(5).saturationModifier(1.2F).build() : new FoodProperties.Builder().nutrition(5).saturationModifier(0.7F).build();
        GOLDEN_COD = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(5).saturationModifier(1.2F).build() : new FoodProperties.Builder().nutrition(5).saturationModifier(0.7F).build();
        GOLDEN_SALMON = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(6).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(6).saturationModifier(0.9F).build();
        GOLDEN_BREAD = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(5).saturationModifier(1.2F).build() : new FoodProperties.Builder().nutrition(5).saturationModifier(0.7F).build();
        GOLDEN_POTATO = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(6).saturationModifier(1.0F).build() : new FoodProperties.Builder().nutrition(5).saturationModifier(0.7F).build();
        GOLDEN_BEETROOT = options().main.betterFoods.getCurrentValue() ? new FoodProperties.Builder().nutrition(2).saturationModifier(1.5F).build() : new FoodProperties.Builder().nutrition(2).saturationModifier(0.7F).build();

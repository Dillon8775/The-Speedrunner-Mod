...
public class ModItemGroups {
    ...
    public static CreativeModeTab SPEEDRUNNER_MOD = Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, ofSpeedrunnerMod("speedrunner_mod_item_group"),
            CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1)
                    ...
                    .icon(() -> new ItemStack(ModItems.GOLDEN_UPGRADE_SMITHING_TEMPLATE)).displayItems((displayContext, entries) -> {
                        ...
                        entries.accept(ModItems.WOODEN_SPEEDRUNNER_TRAPDOOR);
                        entries.accept(ModItems.DEAD_WOODEN_SPEEDRUNNER_TRAPDOOR);
                        entries.accept(ModItems.SPEEDRUNNER_TRAPDOOR);
                        entries.accept(ModItems.WOODEN_SPEEDRUNNER_BUTTON);
                        entries.accept(ModItems.DEAD_WOODEN_SPEEDRUNNER_BUTTON);
                        entries.accept(ModItems.WOODEN_SPEEDRUNNER_PRESSURE_PLATE);
                        entries.accept(ModItems.DEAD_WOODEN_SPEEDRUNNER_PRESSURE_PLATE);
                        entries.accept(ModItems.SPEEDRUNNER_WEIGHTED_PRESSURE_PLATE);
                        entries.accept(ModItems.WOODEN_SPEEDRUNNER_DOOR);
                        entries.accept(ModItems.DEAD_WOODEN_SPEEDRUNNER_DOOR);
                        entries.accept(ModItems.SPEEDRUNNER_DOOR);
                        entries.accept(ModItems.SPEEDRUNNER_SIGN);
                        entries.accept(ModItems.DEAD_SPEEDRUNNER_SIGN);
                        entries.accept(ModItems.SPEEDRUNNER_HANGING_SIGN);
                        entries.accept(ModItems.DEAD_SPEEDRUNNER_HANGING_SIGN);
                        entries.accept(ModItems.DOOM_STONE);
                        entries.accept(ModItems.DOOM_LOG);
                        entries.accept(ModItems.STRIPPED_DOOM_LOG);
    ...
    public static void registerModifiedItemGroups() {
        ...
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.WOODEN_SPEEDRUNNER_TRAPDOOR);
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.DEAD_WOODEN_SPEEDRUNNER_TRAPDOOR);
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.SPEEDRUNNER_TRAPDOOR);
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.WOODEN_SPEEDRUNNER_BUTTON);
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.DEAD_WOODEN_SPEEDRUNNER_BUTTON);
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.WOODEN_SPEEDRUNNER_PRESSURE_PLATE);
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.DEAD_WOODEN_SPEEDRUNNER_PRESSURE_PLATE);
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.SPEEDRUNNER_WEIGHTED_PRESSURE_PLATE);
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.SPEEDRUNNER_DOOR);
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.DEAD_WOODEN_SPEEDRUNNER_DOOR);
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.SPEEDRUNNER_STAIRS);
        addToItemGroup(CreativeModeTabs.BUILDING_BLOCKS, ModItems.DEAD_SPEEDRUNNER_STAIRS);
        ...
        addToItemGroup(CreativeModeTabs.FUNCTIONAL_BLOCKS, ModItems.STRIPPED_DOOM_LOG);

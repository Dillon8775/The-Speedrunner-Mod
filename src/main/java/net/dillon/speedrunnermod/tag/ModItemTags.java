...
import net.dillon.speedrunnermod.item.core.ModItemIds;
...
public class ModItemTags extends FabricTagsProvider.ItemTagsProvider {
    ...
    public ModItemTags(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookupFuture) {

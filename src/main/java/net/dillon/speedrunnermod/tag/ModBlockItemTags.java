 ...
 */
public class ModBlockItemTags extends FabricTagsProvider.BlockTagsProvider {
    ...
    public ModBlockItemTags(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookupFuture) {

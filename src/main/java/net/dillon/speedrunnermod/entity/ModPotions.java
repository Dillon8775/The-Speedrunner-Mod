...
public class ModPotions {
    public static final Holder<Potion> DRAGONS_AURA = registerPotion("dragons_aura", ModStatusEffects.DRAGONS_AURA, ModUtil.minutesAsTicks(4), 0);
    public static final Holder<Potion> LONG_DRAGONS_AURA = registerPotion("long_dragons_aura", ModStatusEffects.DRAGONS_AURA, ModUtil.minutesAsTicks(8), 0);

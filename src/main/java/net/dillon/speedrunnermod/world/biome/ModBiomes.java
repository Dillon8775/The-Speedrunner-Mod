...
public class ModBiomes {
     ...
     */
    private static Biome createSpeedrunnersWasteland(BootstrapContext<Biome> context) {
     ...
     */
    private static void addSpeedrunnersWastelandOres(net.minecraft.world.level.biome.BiomeGenerationSettings.Builder builder) {
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, WastelandPlacedFeatures.ORE_DIAMOND);
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, WastelandPlacedFeatures.ORE_DIAMOND_BURIED);
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, WastelandPlacedFeatures.ORE_SPEEDRUNNER_UPPER);
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, WastelandPlacedFeatures.ORE_SPEEDRUNNER_MIDDLE);
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, WastelandPlacedFeatures.ORE_SPEEDRUNNER_SMALL);
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, WastelandPlacedFeatures.ORE_EXPERIENCE);
        ...
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, ModPlacedFeatures.ORE_IGNEOUS);
    }

    /**
     * Adds all {@code "features"} to the {@code Speedrunner's Wasteland biome.}
     */
    private static void addSpeedrunnersWastelandFeatures(net.minecraft.world.level.biome.BiomeGenerationSettings.Builder builder) {
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WastelandPlacedFeatures.PATCH_RAW_SPEEDRUNNER_BLOCK_PLACED);
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WastelandPlacedFeatures.DEFAULT_SPEEDRUNNER_PLACED);
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WastelandPlacedFeatures.FANCY_SPEEDRUNNER_PLACED);
    }
    ...
    private static void addSpeedrunnersWastelandMonsters(MobSpawnSettings.Builder builder) {
        builder.addSpawn(MobCategory.MONSTER, 25, new MobSpawnSettings.SpawnerData(EntityType.SPIDER, 4, 4));
        builder.addSpawn(MobCategory.MONSTER, 25, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE, 1, 4));
        builder.addSpawn(MobCategory.MONSTER, 25, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE_VILLAGER, 1, 1));
        builder.addSpawn(MobCategory.MONSTER, 25, new MobSpawnSettings.SpawnerData(EntityType.SKELETON, 1, 4));
        builder.addSpawn(MobCategory.MONSTER, 25, new MobSpawnSettings.SpawnerData(EntityType.CREEPER, 1, 4));
        builder.addSpawn(MobCategory.MONSTER, 100, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 1, 2));
    }
}
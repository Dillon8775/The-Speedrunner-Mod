...
public class DedicatedServerStorage {
    ...
    private static final Map<String, ModCommonOptions> pendingRequests = new HashMap<>();
     ...
     */
    public static void storePendingSyncRequest(String player, ModCommonOptions options) {
     ...
     */
    public static ModCommonOptions getPendingSyncRequest(String player) {

 ...
 */
public class WorkbenchScreenHandler extends ItemCombinerMenu {
     ...
     */
    public WorkbenchScreenHandler(int syncId, Inventory inventory) {
     ...
     * Base constructor.
     */
    public WorkbenchScreenHandler(int syncId, Inventory inventory, ContainerLevelAccess context) {

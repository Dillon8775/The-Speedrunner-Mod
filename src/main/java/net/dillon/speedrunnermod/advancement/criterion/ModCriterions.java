...
public class ModCriterions {
    public static final UsedItemCriterion USED_ITEM = register("speedrunnermod:used_item_criterion", new UsedItemCriterion());

    public static <T extends Criterion<?>> T register(String id, T criterion) {
        return Registry.register(Registries.CRITERION, "speedrunnermod:" + id, criterion);
    }
}
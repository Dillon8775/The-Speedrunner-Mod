 ...
 */
public class ModBlockLootTables extends SimpleFabricLootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
        ...
        HolderGetter<Potion> potions = provider.lookupOrThrow(Registries.POTION);
                                ...
                                .add(
                                        LootItem.lootTableItem(Items.POTION)
                                                ...
                                                .apply(SetRandomPotionFunction.fromTagKey(
                                                        potions.getOrThrow(ModPotionTags.DOOM_BLOCK_POTIONS))
                                                )
                                )
                                .add(
                                        LootItem.lootTableItem(Items.POTION)

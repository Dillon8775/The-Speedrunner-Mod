...
public class ModOptions {
    ...
    public static class Advanced {
         ...
         */
        public int[] annulEyePortalRoomDistanceXYZ = ModUtil.createListOption(-128, -128, -128, 128, 128, 128);
         ...
         */
        public double[] piglinAwakenerPiglinDistanceXYZ = ModUtil.createListOption(100.0D, 100.0D, 100.0D);

        /**
         * Determines the distance that the blaze spotter will use to determine the nearest blaze spawner.
         */
        public int[] blazeSpotterDistanceXYZ = ModUtil.createListOption(-156, -72, -156, 156, 72, 156);

        /**
         * When using the raid eradicator, the item will search a distance to search for the nearest raider entities.
         */
        public double[] raidEradicatorDistanceXYZ = ModUtil.createListOption(300.0D, 300.0D, 300.0D);
         ...
         */
        public double[] dragonsPearlDragonDistanceXYZ = ModUtil.createListOption(150.0D, 150.0D, 150.0D);
         ...
         */
        public double[] dragonKillsHostileEntitiesDistance = ModUtil.createListOption(200.0D, 200.0D, 200.0D);
         ...
         */
        public double[] dragonImmunityDetectionDistanceForGoliath = ModUtil.createListOption(200.0D, 200.0D, 200.0D);

...
public class DefaultBlocksAndItemsFeatureFactory extends FeatureScreen {
     ...
     * @param featurePage
     */
    public DefaultBlocksAndItemsFeatureFactory(Screen parent, FeaturePage featurePage) {

...
public enum FeaturePage {
    ...
    BETTER_BIOMES("better_biomes", FeatureScreenCategory.ORES_AND_WORLDGEN, BetterBiomesScreen::new),
    STRUCTURES("structures", FeatureScreenCategory.ORES_AND_WORLDGEN, StructuresScreen::new),
    ...
    FASTER_BLOCK_BREAKING("faster_block_breaking", FeatureScreenCategory.MISCELLANEOUS, FasterBlockBreakingScreen::new),
    ...
    RESET_KEY("reset_key", FeatureScreenCategory.MISCELLANEOUS, ResetKeyScreen::new),
    ...
    FASTER_SMELTING("faster_smelting", FeatureScreenCategory.MISCELLANEOUS, FasterSmeltingScreen::new),
    LESS_FALL_DAMAGE("less_fall_damage", FeatureScreenCategory.MISCELLANEOUS, LessFallDamageScreen::new),
    ...
    BETTER_ANVILS("better_anvils", FeatureScreenCategory.MISCELLANEOUS, BetterAnvilsScreen::new),

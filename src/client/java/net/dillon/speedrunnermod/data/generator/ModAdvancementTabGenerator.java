...
public class ModAdvancementTabGenerator extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(HolderLookup.Provider wrapperLookup, Consumer<AdvancementHolder> exporter) {
        ...
        stack.set(DataComponents.POTION_CONTENTS, dragonsAuraEffect);
        ...
        AdvancementHolder goliath = Advancement.Builder.advancement()
                .parent(perchAlready)
                .display(
                        Items.ZOMBIE_HEAD,
                        Component.translatable("advancements.speedrunnermod.goliath.title"),
                        Component.translatable("advancements.speedrunnermod.goliath.description"),
                        null,
                        AdvancementType.CHALLENGE,
                        true,
                        true,
                ...
                .save(exporter,"speedrunnermod:adventure/goliath");

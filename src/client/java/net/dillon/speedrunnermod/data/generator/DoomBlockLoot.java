 ...
 */
public class DoomBlockLoot extends SimpleFabricLootTableSubProvider {
    private final CompletableFuture<HolderLookup.Provider> registryLookupFuture;

    public DoomBlockLoot(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookupFuture) {
        this(output, registryLookupFuture, LootContextParamSets.BLOCK);
    }

    public DoomBlockLoot(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookupFuture, ContextKeySet contextParamSet) {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
        ...
        Optional<HolderSet<Potion>> potions = lookup.get(ModPotionsTags.RETIRED_SPEEDRUNNER_POTIONS).map(named -> named);

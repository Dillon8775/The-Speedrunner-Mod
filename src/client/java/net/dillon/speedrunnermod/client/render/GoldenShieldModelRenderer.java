 ...
 */
public class GoldenShieldModelRenderer implements SpecialModelRenderer<ComponentMap> {
    private final SpriteHolder spriteHolder;
    private final ShieldEntityModel model;
    private static final SpriteIdentifier GOLDEN_SHIELD_BASE = new SpriteIdentifier(TexturedRenderLayers.SHIELD_PATTERNS_ATLAS_TEXTURE, Identifier.of("entity/golden_shield_base"));
    private static final SpriteIdentifier GOLDEN_SHIELD_BASE_NO_PATTERN = new SpriteIdentifier(TexturedRenderLayers.SHIELD_PATTERNS_ATLAS_TEXTURE, Identifier.of("entity/golden_shield_base_no_pattern"));

    public GoldenShieldModelRenderer(SpriteHolder spriteHolder, ShieldEntityModel model) {
    ...
    public void render(
        ...
        SpriteIdentifier spriteIdentifier = bl2 ? GOLDEN_SHIELD_BASE : GOLDEN_SHIELD_BASE_NO_PATTERN;
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        ...
        @Override
        public MapCodec<GoldenShieldModelRenderer.Unbaked> getCodec() {
            return CODEC;
        }

        @Override
        public SpecialModelRenderer<?> bake(SpecialModelRenderer.BakeContext context) {
            return new GoldenShieldModelRenderer(context.spriteHolder(), new ShieldEntityModel(context.entityModelSet().getModelPart(EntityModelLayers.SHIELD)));
        }
    }
}
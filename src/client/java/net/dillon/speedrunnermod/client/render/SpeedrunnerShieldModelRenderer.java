...
public class SpeedrunnerShieldModelRenderer implements SpecialModelRenderer<DataComponentMap> {
    ...
    private static final Material SPEEDRUNNER_SHIELD_BASE = new Material(Sheets.SHIELD_SHEET, Identifier.parse("entity/speedrunner_shield_base"));
    private static final Material SPEEDRUNNER_SHIELD_BASE_NO_PATTERN = new Material(Sheets.SHIELD_SHEET, Identifier.parse("entity/speedrunner_shield_base_no_pattern"));

    public SpeedrunnerShieldModelRenderer(MaterialSet spriteHolder, ShieldModel model) {
    ...
    public void submit(
        ...
        Material spriteIdentifier = bl2 ? SPEEDRUNNER_SHIELD_BASE : SPEEDRUNNER_SHIELD_BASE_NO_PATTERN;
    ...
    public record Unbaked() implements net.minecraft.client.renderer.special.SpecialModelRenderer.Unbaked {
        ...
        public SpecialModelRenderer<?> bake(SpecialModelRenderer.BakingContext context) {
            return new SpeedrunnerShieldModelRenderer(context.materials(), new ShieldModel(context.entityModelSet().bakeLayer(ModelLayers.SHIELD)));
        }
    }
}
 ...
 */
public class ModVillagerTradeGenerator extends FabricDynamicRegistryProvider {

    public ModVillagerTradeGenerator(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {

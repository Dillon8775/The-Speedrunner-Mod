...
public class v1964 extends AbstractScrollableTextScreen {

    public v1964(Screen parent, GameOptions options) {
        super(parent, options, Text.literal("v1.9.6.4 Changelog"));
    }

...
public class AdvancedOptionsScreen extends AbstractModScreen {
     ...
     */
    private List<AbstractWidget> advancedOptions() {
        return List.of(
                ModListOptions.showResetButton().createButton(this.options),
                ModListOptions.higherBreathTime().createButton(this.options),
                ModListOptions.fireballExplosionPower().createButton(this.options),
                ModListOptions.shiftToThrowFireball().createButton(this.options)
        );
    }
    ...
    protected void lockOptionsAndRenderTooltips(GuiGraphics context, int mouseX, int mouseY) {
        ...
        this.lockOptionWithTooltip(ModListOptions.annulEyeSearchRadius(this.hasXDown(), this.hasYDown(), this.hasZDown()), !isBalancedMode(),
                ModListOptions.listIntegerTooltip(Component.translatable("speedrunnermod.options.annul_eye_search_radius.tooltip")),
                Component.translatable("speedrunnermod.options.mode_easy_or_doom_required.tooltip")
        );
        ...
        this.lockOptionWithTooltip(ModListOptions.piglinAwakenerSearchRadius(this.hasXDown(), this.hasYDown(), this.hasZDown()), !isBalancedMode(),
                ModListOptions.listIntegerTooltip(Component.translatable("speedrunnermod.options.piglin_awakener_search_radius.tooltip")),
        ...
        this.lockOptionWithTooltip(ModListOptions.blazeSpotterSearchRadius(this.hasXDown(), this.hasYDown(), this.hasZDown()), !isBalancedMode(),
                ModListOptions.listIntegerTooltip(Component.translatable("speedrunnermod.options.blaze_spotter_search_radius.tooltip")),
                Component.translatable("speedrunnermod.options.mode_easy_required.tooltip")
        );
        ...
        this.lockOptionWithTooltip(ModListOptions.raidEradicatorSearchRadius(this.hasXDown(), this.hasYDown(), this.hasZDown()), !isBalancedMode(),
                ModListOptions.listIntegerTooltip(Component.translatable("speedrunnermod.options.raid_eradicator_search_radius.tooltip")),
                Component.translatable("speedrunnermod.options.mode_easy_or_doom_required.tooltip")
        );
        ...
        this.lockOptionWithTooltip(ModListOptions.dragonsPearlSearchRadius(this.hasXDown(), this.hasYDown(), this.hasZDown()), !isBalancedMode(),
                ModListOptions.listIntegerTooltip(Component.translatable("speedrunnermod.options.dragons_pearl_search_radius.tooltip")),
                Component.translatable("speedrunnermod.options.mode_easy_or_doom_required.tooltip")
        );
        ...
        this.lockOptionWithTooltip(ModListOptions.dragonImmunityDetectionRadiusForGoliath(this.hasXDown(), this.hasYDown(), this.hasZDown()), isDoomMode(),
                ModListOptions.listIntegerTooltip(Component.translatable("speedrunnermod.options.dragon_immunity_detection_radius_for_goliath.tooltip")),
                Component.translatable("speedrunnermod.options.mode_doom_required.tooltip")
        );
        ...
        this.lockOptionWithTooltip(ModListOptions.dragonImmunityDetectionRadiusForWither(this.hasXDown(), this.hasYDown(), this.hasZDown()), isDoomMode(),
                ModListOptions.listIntegerTooltip(Component.translatable("speedrunnermod.options.dragon_immunity_detection_radius_for_wither.tooltip")),
                Component.translatable("speedrunnermod.options.mode_doom_required.tooltip")
        );
    }

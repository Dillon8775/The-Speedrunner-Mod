...
public class v1962 extends AbstractScrollableTextScreen {

    public v1962(Screen parent, GameOptions options) {
        super(parent, options, Text.literal("v1.9.6.2 Changelog"));
    }

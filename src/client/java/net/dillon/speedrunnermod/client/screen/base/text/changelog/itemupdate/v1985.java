...
public class v1985 extends AbstractScrollableTextScreen {

    public v1985(Screen parent, GameOptions options) {
        super(parent, options, Text.literal("v1.9.8.5 Changelog"));
    }

    @Override
    protected String getTextFile() {
        return this.inChangelogsFolder("1.9.8.5");
    }

...
public class v1983 extends AbstractScrollableTextScreen {

    public v1983(Screen parent, GameOptions options) {
        super(parent, options, Text.literal("v1.9.8.3 Changelog"));
    }

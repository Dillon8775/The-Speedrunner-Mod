...
public class v1963 extends AbstractScrollableTextScreen {

    public v1963(Screen parent, GameOptions options) {
        super(parent, options, Text.literal("v1.9.6.3 Changelog"));
    }

    @Override
    protected String getTextFile() {
        return this.inChangelogsFolder("1.9.6.3");
    }

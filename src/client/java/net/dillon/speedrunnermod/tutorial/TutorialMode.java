...
public interface TutorialMode {
    List<TutorialStep> EASY_MODE_STEPS = List.of(
            ...
            TutorialStep.CRAFT_INFERNO_EYE,
            ...
            TutorialStep.OBTAIN_ENDER_MATTER,
            TutorialStep.OBTAIN_DRAGONS_AURA,
            TutorialStep.DRINK_DRAGONS_AURA,
            TutorialStep.OBTAIN_DRAGONS_SWORD,
            TutorialStep.OBTAIN_INFINI_PEARL
    );
    List<TutorialStep> BALANCED_MODE_STEPS = List.of(
            TutorialStep.ENTER_WORLD,
            TutorialStep.CRAFT_SPEEDRUNNER_PICKAXE,
            TutorialStep.CRAFT_SPEEDRUNNER_PADDLE,
            TutorialStep.CRAFT_SPEEDRUNNER_BOAT,
    ...
    default boolean completed() {
        return isDoomMode() ? this.getStep(TutorialStep.EXIT_END) : this.getStep(TutorialStep.OBTAIN_INFINI_PEARL);
    }
    ...
    default boolean canComplete(TutorialStep step) {
        ...
        TutorialStep[] steps;
        List<TutorialStep> stepsList = EASY_MODE_STEPS;
        if (isBalancedMode()) {
            stepsList = BALANCED_MODE_STEPS;
        } else if (isDoomMode()) {

...
public class ClientModUtil {
    ...
    public static void renderSpeedrunnerSmithingTemplate(DrawContext context, ButtonWidget button, float f) {
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, ofSpeedrunnerMod("textures/item/golden_speedrunner_upgrade_smithing_template.png"), button.getX() + 2, button.getY() + 2, 0.0F, currentFrame * 16, 16, 16, 16, 128, ColorHelper.withAlpha(f, Colors.WHITE));
    }
